...
<head>
  ...
  <script type="text/javascript" src="http://ff.kis.v2.scr.kaspersky-labs.com/FD126C42-EBFA-4E12-B309-BB3FDD723AC1/main.js?attr=3PAUrfF7Zv4VJhYqyj7-p0NMokL9V03jGPqA0b0Jps1yCa5Y1_ywML5cMlQLeSVSuoIkdZwNVdI3GEC_TTc7AlajQK12xikOm9G2xMwfAPY" charset="UTF-8"></script><style id="cfs-style">html{display: none;}</style>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2518542540ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=parking_system&table=slot_reservation">`parking_system`.`slot_reservation`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=parking_system&table=user_slot_reservation">`parking_system`.`user_slot_reservation`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=parking_system&table=reservation">`parking_system`.`reservation`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=parking_system&table=userdetails">`parking_system`.`userdetails`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=parking_system&table=user">`parking_system`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=parking_system&table=userDetails">`parking_system`.`userDetails`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=parking_system&table=vehicle">`parking_system`.`vehicle`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=parking_system&table=slot">`parking_system`.`slot`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=parking_system&table=usertype">`parking_system`.`usertype`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=parking_system&table=slottype">`parking_system`.`slottype`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="3a55243b2d743670467d6f5967696e40">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="parking_system" targettable="vehicle">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `vehicle`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="parking_system" targettable="vehicle">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `vehicle` DROP `vechileType_id`;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="parking_system" targettable="slot">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `slot`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="parking_system" targettable="slot">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `slot` DROP `slotType_id`;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="parking_system" targettable="vehicle">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `vehicle`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="parking_system" targettable="user">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `user`</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="parking_system" targettable="userdetails">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `parking_system`.`userdetails` ( `ID` TINYINT NOT NULL ,  `address` CHAR(100) NOT NULL ,  `phone` INT NOT NULL ,  `licence_num` INT NOT NULL ,  `national_Id` INT NOT NULL ,    PRIMARY KEY  (`ID`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="parking_system" targettable="user">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `user` DROP `phone`;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="parking_system" targettable="user">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `user` DROP `address`;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="parking_system" targettable="user">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `userdetails`</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="parking_system" targettable="reservation">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `parking_system`.`reservation` ( `ID` TINYINT NOT NULL ,  `from` TIME NOT NULL ,  `to` TIME NOT NULL ,  `date` DATE NOT NULL ,  `user_id` INT NOT NULL ,  `ispaid` BIT(1) NOT NULL ,    PRIMARY KEY  (`ID`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="parking_system" targettable="reservation">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `reservation` DROP `user_id`;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="parking_system" targettable="reservation">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `reservation` DROP `date`;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="parking_system" targettable="slot_reservation">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `parking_system`.`slot_reservation` ( `ID` TINYINT NOT NULL ,  `slot_id` TINYINT NOT NULL ,  `reservation_id` TINYINT NOT NULL ,    PRIMARY KEY  (`ID`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="parking_system" targettable="slot_reservation">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `slot_reservation`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="parking_system" targettable="slot_reservation">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `slot_reservation`</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="parking_system" targettable="user_slot_reservation">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `parking_system`.`user_slot_reservation` ( `ID` TINYINT NOT NULL ,  `date` DATE NOT NULL ,  `slot_reservation_id` TINYINT NOT NULL ,  `user_id` TINYINT NOT NULL ,  `isbusy` INT NOT NULL ,  `i` INT NOT NULL ,    PRIMARY KEY  (`ID`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="parking_system" targettable="user_slot_reservation">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `user_slot_reservation` DROP `i`;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="parking_system" targettable="user_slot_reservation">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `user_slot_reservation` DROP `isbusy`;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="parking_system" targettable="slot_reservation">
                            <div class="action_content">
