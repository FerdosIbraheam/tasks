...
<head>
  ...
  <!-- nice selecy -->
  <link rel="stylesheet" href="resources/css/nice-select.min.css">
...
<body>
  ...
  <div class="hero_area">
    <div class="bg-box">
      <img src="resources/images/slider-bg.jpg" alt="">
    </div>
        ...
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  ">
              ...
              ?>
              <li class="nav-item">
                <a class="nav-link" href="Admin/users/edit.php?id=<?php echo $_SESSION['loginuser']['ID']?>">my profile</a>
              </li>
            <?php }else{ ?>
           
              <li class="nav-item">
                <a class="nav-link" href="Admin/users/create.php">register</a>
              </li>
            <?php } ?>
            </ul>
  ...
  <section class="pricing_section layout_padding">
    <div class="bg-box">
      <img src="resources/images/pricing-bg.jpg" alt="">
    </div>
    <div class="container">
          ...
          <div class="owl-carousel client_owl-carousel">
            <div class="item">
              <div class="box">
                ...
                <div class="client_id">
                  <div class="img-box">
                    <img src="resources/images/c1.jpg" alt="" class="img-1">
                  </div>
                  <div class="name">
                    <h6>
                      Lisa Adams
            ...
            <div class="item">
              <div class="box">
                ...
                <div class="client_id">
                  <div class="img-box">
                    <img src="resources/images/c2.jpg" alt="" class="img-1">
                  </div>
                  <div class="name">
                    <h6>
                      Michel Trout
